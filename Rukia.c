  ...
  while(1) {
    ...
    FILE *fp=fopen("Guide.txt","r");
     fgets(p.str,"500",fp);
        ...
        printf(">%s\n","Please type random for random number game,divide,add,substract,multiplication for calculating numbers,time to know the time,date to know the daate and exit to exit from the function");
        continue;
       }
